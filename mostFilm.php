            ...
            <center>
                <table border = "1" id="lista" class="comp">
                    <tr>
                        ...
                        $cont = 1;
                        $id = $_SESSION["id"];
                        $sql = "SELECT id_film,regista,genere,cover,titolo,COUNT(grade) as num,AVG(grade) as media FROM Film INNER JOIN FilmVisti ON Film.id = FilmVisti.id_film GROUP BY id_film ORDER BY num DESC, media DESC";
