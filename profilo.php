    ...
    <nav id="nav" class="navbar navbar-inverse"  style="border-radius: 0px; border: none; z-index: 1;">
		...
		<div class="container" id="cont">
                ...
                <table id="data" class="comp">
                    <tr>
                        <td style="padding: 10px;" rowspan="4"><div id="picture" style="width: 200px; height: 200px; background-image: url('<?php echo $img; ?>'); background-size: cover;">
                        <a href="info.php"><span id="setting" class="glyphicon glyphicon-cog"></span></a></div></td>
                        <th>Name:</th>
             ...
             <center>
                ...
                <br>
                <a class="tel" href="info.php"><button style="margin-top: 30px;" type="button" class="btn btn-danger"><span style="padding-right: 3px;">Edit </span><span class="glyphicon glyphicon-pencil"></span></button></a>
            </center>
			<center>
